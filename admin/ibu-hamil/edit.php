...
<?php
$id  = $_GET['id'];
$data = $koneksi->query("SELECT * FROM ibu_hamil WHERE id_ibu_hamil = '$id'")->fetch_array();
?>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Edit Data Ibu Hamil</h1>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="card card-outline card-success">
                                <form class="form-horizontal" action="proses" method="POST" id="form-input">
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="id_ibu_hamil" readonly value="<?= $data['id_ibu_hamil'] ?>">

                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">No. Registrasi KIA</label>
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="no_kia" onkeypress="return Angkasaja(event)" autofocus autocomplete="off" required value="<?= $data['no_kia'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="nama_ibu_hamil" autocomplete="off" required value="<?= $data['nama_ibu_hamil'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="nama_suami" autocomplete="off" required value="<?= $data['nama_suami'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="status_kehamilan" autocomplete="off" required value="<?= $data['status_kehamilan'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="date" class="form-control" name="hpht" autocomplete="off" required value="<?= $data['hpht'] ?>">
                                            </div>
                                        </div>
