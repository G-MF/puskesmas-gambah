        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Tambah Data Pemeriksaan Ibu Hamil</h1>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <form class="form-horizontal" action="proses" method="POST" id="form-input">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="number" class="form-control" name="berat_badan" autocomplete="off" required step="0.1" placeholder="Masukkan angka saja" value="<?= isset($_SESSION['valid']) ? $_SESSION['valid']['berat_badan'] : '' ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="tinggi_fundus" autocomplete="off" required onkeypress="return Angkasaja(event)" placeholder="Masukkan angka saja" value="<?= isset($_SESSION['valid']) ? $_SESSION['valid']['tinggi_fundus'] : '' ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="letak_janin" autocomplete="off" required value="<?= isset($_SESSION['valid']) ? $_SESSION['valid']['letak_janin'] : '' ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="denyut_jantung" autocomplete="off" required onkeypress="return Angkasaja(event)" placeholder="Masukkan angka saja" value="<?= isset($_SESSION['valid']) ? $_SESSION['valid']['denyut_jantung'] : '' ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <a href="../pemeriksaan-ibu-hamil/" class="btn bg-gradient-dark" onclick="<?php unset($_SESSION['valid']) ?>"><i class="fa fa-arrow-alt-circle-left"> Batal</i></a>
                                    </div>
                                </form>
                            </div>
