...
<?php
$id   = $_GET['id'];
$data = $koneksi->query("SELECT * FROM perkembangan_gizi_tinggi_badan p LEFT JOIN anak a ON p.id_anak = a.id_anak WHERE id_gizi_tb = '$id'")->fetch_array();
?>
        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Edit Data Perkembangan Gizi Tinggi Badan</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Dashboard</li>
                                <li class="breadcrumb-item">Perkembangan Gizi Tinggi Badan</li>
                            ...
                            <div class="card card-outline card-success">
                                <form class="form-horizontal" action="proses" method="POST" id="form-input">
                                    <div class="card-body">
                                        ...
                                        <input type="hidden" name="id_gizi_tb" readonly value="<?= $id ?>">
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <a href="../perkembangan-gizi-tb/" class="btn bg-gradient-dark"><i class="fa fa-arrow-alt-circle-left"> Batal</i></a>
                                    </div>
                                </form>
                            </div>
