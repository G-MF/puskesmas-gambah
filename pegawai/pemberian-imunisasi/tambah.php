        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Tambah Data Pemberian Imunisasi</h1>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="card card-outline card-success">
                                <form class="form-horizontal" action="proses" method="POST" id="form-input">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <select name="id_imunisasi" class="form-control select2" data-placeholder="Pilih" style="width: 100%;" autofocus>
                                                    ...
                                                    ?>
                                                        <option value="<?= $imunisasi['id_imunisasi'] ?>" <?php if (isset($_SESSION['valid'])) {
                                                                                                                echo $_SESSION['valid']['id_imunisasi'] == $imunisasi['id_imunisasi'] ? "selected" : '';
                                                                                                            } ?>><?= $imunisasi['jenis_imunisasi'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <a href="../pemberian-imunisasi/" class="btn bg-gradient-dark" onclick="<?php unset($_SESSION['valid']) ?>"><i class="fa fa-arrow-alt-circle-left"> Batal</i></a>
                                    </div>
                                </form>
                            </div>
