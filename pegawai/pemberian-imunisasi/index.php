        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Data Pemberian Imunisasi</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Dashboard</li>
                                <li class="breadcrumb-item active">Pemberian Imunisasi</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card card-outline card-success">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $data = $koneksi->query('SELECT * FROM pemberian_imunisasi p LEFT JOIN anak a ON p.id_anak = a.id_anak LEFT JOIN jenis_imunisasi j ON p.id_imunisasi = j.id_imunisasi ORDER BY id_pemberian_imunisasi DESC');
                                            ...
                                            ?>
                                                <tr align="center">
                                                    ...
                                                    <td>
                                                        <a href="edit?id=<?= $item['id_pemberian_imunisasi'] ?>" class="btn bg-gradient-info btn-sm"><i class="fa fa-edit"> Edit</i></a>
                                                        <button type="button" class="btn bg-gradient-danger btn-sm delete" data-link="proses?id=<?= $item['id_pemberian_imunisasi'] ?>" data-name="<?= $item['nama_anak'] ?>">
