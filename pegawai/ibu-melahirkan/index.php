        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Data Ibu Melahirkan</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item">Dashboard</li>
                                <li class="breadcrumb-item active">Ibu Melahirkan</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card card-outline card-success">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $data = $koneksi->query('SELECT * FROM ibu_hamil_melahirkan m LEFT JOIN ibu_hamil i ON m.id_ibu_hamil = i.id_ibu_hamil ORDER BY id_kelahiran DESC');
                                            ...
                                            ?>
                                                <tr align="center">
                                                    ...
                                                    <td>
                                                        <a href="edit?id=<?= $item['id_kelahiran'] ?>" class="btn bg-gradient-info btn-sm"><i class="fa fa-edit"> Edit</i></a>
                                                        <button type="button" class="btn bg-gradient-danger btn-sm delete" data-link="proses?id=<?= $item['id_kelahiran'] ?>" data-name="<?= $item['nama_ibu_hamil'] ?>">
