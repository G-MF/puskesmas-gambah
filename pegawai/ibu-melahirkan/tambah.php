        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Tambah Data Ibu Melahirkan</h1>
                        </div>
                        <div class="col-sm-6">
                            ...
                            <div class="card card-outline card-success">
                                <form class="form-horizontal" action="proses" method="POST" id="form-input">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="date" class="form-control" name="tgl_melahirkan" autocomplete="off" required value="<?= isset($_SESSION['valid']) ? $_SESSION['valid']['tgl_melahirkan'] : date('Y-m-d') ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="tempat_persalinan" autocomplete="off" required value="<?= isset($_SESSION['valid']) ? $_SESSION['valid']['tempat_persalinan'] : '' ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="penolong_persalinan" autocomplete="off" required value="<?= isset($_SESSION['valid']) ? $_SESSION['valid']['penolong_persalinan'] : '' ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="keadaan_ibu" autocomplete="off" required value="<?= isset($_SESSION['valid']) ? $_SESSION['valid']['keadaan_ibu'] : '' ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="keadaan_anak" autocomplete="off" required value="<?= isset($_SESSION['valid']) ? $_SESSION['valid']['keadaan_anak'] : '' ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <a href="../ibu-melahirkan/" class="btn bg-gradient-dark" onclick="<?php unset($_SESSION['valid']) ?>"><i class="fa fa-arrow-alt-circle-left"> Batal</i></a>
                                    </div>
                                </form>
                            </div>
