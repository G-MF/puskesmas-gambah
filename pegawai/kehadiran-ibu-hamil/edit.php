        ...
        <div class="content-wrapper">
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Edit Data Kehadiran Ibu Hamil</h1>
                        </div>
                        <div class="col-sm-6">
                                ...
                                <form class="form-horizontal" action="proses" method="POST" id="form-input">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10 form-valid">
                                                <input type="text" class="form-control" name="berat_badan" autocomplete="off" required onkeypress="return Angkasaja(event)" placeholder="Masukkan angka saja" value="<?= $data['berat_badan'] ?>">
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer text-center">
                                        ...
                                        <a href="../kehadiran-ibu-hamil/" class="btn bg-gradient-dark"><i class="fa fa-arrow-alt-circle-left"> Batal</i></a>
                                    </div>
                                </form>
                            </div>
