...
if (isset($_POST['cetak_semua'])) {
    ...
    $data      = $koneksi->query("SELECT * FROM kehadiran_ibu_hamil k LEFT JOIN ibu_hamil i ON k.id_ibu_hamil = i.id_ibu_hamil WHERE i.id_ibu_hamil = '$id_ibu_hamil'");
...
<body>
    ...
    <h3 align="center">
        LAPORAN REKAM MEDIS IBU HAMIL <br>
        <small><?= $ket; ?></small>
    </h3>
