...
if (isset($_POST['cetak'])) {
    $tgl1 = $_POST['tgl1'];
    $tgl2 = $_POST['tgl2'];
    $data = $koneksi->query("SELECT * FROM perkembangan_gizi_tinggi_badan p LEFT JOIN anak a ON p.id_anak = a.id_anak WHERE tgl_cek BETWEEN '$tgl1' AND '$tgl2'");
}
?>
...
<head>
    ...
    <title>Laporan Perkembangan Gizi Tinggi Badan</title>
...
<body>
    ...
    <h3 align="center">
        LAPORAN DATA PERKEMBANGAN GIZI TINGGI BADAN <br>
