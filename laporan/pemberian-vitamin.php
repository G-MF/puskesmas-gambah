...
if (isset($_POST['cetak'])) {
    $tgl1 = $_POST['tgl1'];
    $tgl2 = $_POST['tgl2'];
    $data = $koneksi->query("SELECT * FROM pemberian_vitamin p LEFT JOIN anak a ON p.id_anak = a.id_anak LEFT JOIN jenis_vitamin j ON p.id_vitamin = j.id_vitamin WHERE tgl_pemberian BETWEEN '$tgl1' AND '$tgl2'");
}
?>
...
<head>
    ...
    <title>Laporan Pemberian Vitamin</title>
...
<body>
    ...
    <h3 align="center">
        LAPORAN DATA PEMBERIAN VITAMIN <br>
