...
if (isset($_POST['cetak'])) {
    $tgl1 = $_POST['tgl1'];
    $tgl2 = $_POST['tgl2'];
    $data = $koneksi->query("SELECT * FROM kematian_anak k LEFT JOIN anak a ON k.id_anak = a.id_anak WHERE tgl_kematian BETWEEN '$tgl1' AND '$tgl2'");
}
?>
...
<head>
    ...
    <title>Laporan Kematian Anak</title>
